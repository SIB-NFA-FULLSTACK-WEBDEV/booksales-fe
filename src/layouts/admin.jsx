            ...
            <ul className="pt-5 mt-5 space-y-2 borderT border-gray-200 dark:border-gray-700">
              ...
              <li>
                <button
                  ...
                  className="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg transition duration-75 hover:bg-red-200 dark:hover:bg-red-700 dark:text-white group"
                >
